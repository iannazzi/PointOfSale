...
SELECT  pos_purchases_journal.pos_purchases_journal_id,  
		...
		IF (pos_purchases_journal.invoice_type = 'REGULAR', 
			(SELECT GROUP_CONCAT(concat(pos_purchase_orders.pos_purchase_order_id,' ',pos_purchase_orders.purchase_order_number) SEPARATOR ', ') 
				...
				WHERE pos_purchases_invoice_to_po.pos_purchases_journal_id = pos_purchases_journal.pos_purchases_journal_id),
			(SELECT GROUP_CONCAT(concat(pos_purchase_orders.pos_purchase_order_id,' ',pos_purchase_orders.purchase_order_number) SEPARATOR ', ') 
				FROM pos_purchase_orders
				...
				WHERE pos_purchases_credit_memo_to_po.pos_purchases_journal_id = pos_purchases_journal.pos_purchases_journal_id))
		as purchase_order_numbers,
