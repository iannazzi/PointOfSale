//these functions are called from table objects, updating them could result in errors....
//FUNCTIONS NEEDED FOR TABLES
//this is the table cell creator for user input
...
//These are older functions for some of the first tables I built
