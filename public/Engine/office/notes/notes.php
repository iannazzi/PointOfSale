...
function createDiscountTableDef($type, $pos_discount_id)
{
	...
	return array( 
						...
						array('db_field' =>  'discount_name',
								...
								'validate' => 'none'),
						array('db_field' =>  'discount_type',
								'type' => 'select',
								'caption' => 'Discount Type',
								'html' => createEnumSelect('discount_type','pos_discounts', 'discount_type', 'false',  'off')),
						...
						array('db_field' =>  'post_expiration_discount_amount',
								'type' => 'input',
								'caption' => 'Post Expiration Discount Amount',
								'validate' => 'number'),
						...
						array('db_field' =>  'check_if_can_be_applied_to_sale_items',
								'type' => 'checkbox',
								'caption' => 'Check This if Discount Can Be Applied To Sale Items',
								'value' => '0'),
