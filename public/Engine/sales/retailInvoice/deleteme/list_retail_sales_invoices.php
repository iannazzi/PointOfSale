...
$table_columns = array(
	...
	array(
			...
			'total' => 2),
		array(
			'th' => 'Pre Tax Promotions<br>(In-Store Info Only)',
			'mysql_field' => 'pre_tax_promotion_total',
			'sort' => 'pre_tax_promotion_total',
			'round' => 2,
			'total' => 2),	
		array(
			'th' => 'Post Tax Promotions<BR>(payment)',
			'mysql_field' => 'post_tax_promotion_total',
			'sort' => 'post_tax_promotion_total',
			'round' => 2,
			'total' => 2),	
