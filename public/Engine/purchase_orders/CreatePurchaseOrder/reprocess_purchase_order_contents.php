...
$html .= '<p><INPUT class = "button" type="button" style = "width:180px" disabled = "disabled" value="Edit Contents" onclick="window.location = \'purchase_order_contents.php?pos_purchase_order_id=' .$pos_purchase_order_id. '\'" />';
$html .= '<INPUT class = "button" type="button" style = "width:100px" value="Process" onclick="window.location =\''.$continue_location . '\'" />';
