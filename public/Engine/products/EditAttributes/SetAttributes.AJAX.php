 ...
 */
 ...
 /* to test type in the url:
 	http://www.embrasse-moi.com/POS/products/SetAttributes.AJAX.php?product_id=856&name=test%20size%204&options=%5B%2232%22%2C%22%22%2C%2243%22%2C%2246%22%2C%2245%2067%22%2C%22%22%5D
 */
 // recieve post data like this
 //// recieve it like this: $data = file_get_contents("php://input");

if ( (isset($_GET['product_id'])) && (is_numeric($_GET['product_id'])) && (isset($_GET['options'])) && (isset($_GET['name'])) )
...
$access_type = 'WRITE';
	...
	$product_attribute_sql = "INSERT INTO pos_products_attributes (pos_product_id, name, caption, options) VALUES ('$product_id', '$name', '$name', '$options')";	
