...
//Class_Initialize Event @5-4B35A2FA
...
//Initialize Objects @1-734050D1

// Controls
$header = & new clsheader("", "header", $MainPage);
$header->Initialize();
$Login = & new clsRecordLogin("", $MainPage);
$register = & new clsControl(ccsLink, "register", "register", ccsText, "", CCGetRequestParam("register", ccsGet, NULL), $MainPage);
$register->Page = "registration.php";
$remind = & new clsControl(ccsLink, "remind", "remind", ccsText, "", CCGetRequestParam("remind", ccsGet, NULL), $MainPage);
