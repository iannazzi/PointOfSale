...
//Modifications are not recommened except in (*_events.php) files.
...
//-----------------------------------------------------------------------------------------------------------------
// The variable which specifies either VCalendar or the installation will be started.  Possible values (true, false)
// If false install/install.php will be run while opening VCalendar
//------------------------------------------------------------------------------------------------------------------
$CalendarIsInstalled = false;


//Connection Settings @0-CDA8A54B
...
//Initialize Common Variables @0-772DB5F3
...
$CCSLocales->AddLocale("de", Array("de", "DE", array("Ja", "Nein", ""), 2, ",", ".", array("Januar", "Februar", "März", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"), array("Jan", "Feb", "Mrz", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dez"), array("Sonntag", "Montag", "Dienstag", "Mittwoch", "Donnerstag", "Freitag", "Samstag"), array("So", "Mo", "Di", "Mi", "Do", "Fr", "Sa"), array("S", "M", "D", "M", "D", "F", "S"), array("dd", ".", "mm", ".", "yyyy"), array("dddd", ", ", "d", ". ", "mmmm", " ", "yyyy"), array("HH", ":", "nn"), array("HH", ":", "nn", ":", "ss"), "", "", 1, false, "", "utf-8", "UTF-8"));
...
//calendar Connection Class @-C6E36600
...
//CCBuildInsert @0-AC0C3C06
function CCBuildInsert($table, & $Fields, & $Connection)
{
    $fields = array();
    $values = array();
    foreach ($Fields as $Field) {
        if (!isset($Field["OmmitIfEmpty"]) || !$Field["OmmitIfEmpty"] || !is_null($Field["Value"])) {
            $fields[] = $Field["Name"];
...
//CCConvertEncodingArray @0-03AF2C52
...
//CCSelectProjectStyle @0-38A140B5
