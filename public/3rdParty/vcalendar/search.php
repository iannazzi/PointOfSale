...
//Class_Initialize Event @9-675B7436
    function clsRecordevents_groupsSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->s_keyword = & new clsControl(ccsTextBox, "s_keyword", $CCSLocales->GetText("event_title"), ccsText, "", CCGetRequestParam("s_keyword", $Method, NULL), $this);
            $this->s_category = & new clsControl(ccsListBox, "s_category", $CCSLocales->GetText("cal_category"), ccsText, "", CCGetRequestParam("s_category", $Method, NULL), $this);
...
"FROM categories_langs {SQL_Where} {SQL_OrderBy}";
            $this->s_category->DataSource->Parameters["seslocale"] = CCGetSession("locale", NULL);
            ...
            $this->s_event_date_from = & new clsControl(ccsTextBox, "s_event_date_from", $CCSLocales->GetText("event_date") . " " . $CCSLocales->GetText("from"), ccsDate, array("ShortDate"), CCGetRequestParam("s_event_date_from", $Method, NULL), $this);
            ...
            $this->s_event_date_to = & new clsControl(ccsTextBox, "s_event_date_to", $CCSLocales->GetText("event_date") . " " . $CCSLocales->GetText("to"), ccsDate, array("ShortDate"), CCGetRequestParam("s_event_date_to", $Method, NULL), $this);
...
//Class_Initialize Event @5-06173723
    function clsGridevents_groups($RelativePath, & $Parent)
    {
        ...
        $this->event_date = & new clsControl(ccsLabel, "event_date", "event_date", ccsDate, array("ShortDate"), CCGetRequestParam("event_date", ccsGet, NULL), $this);
        $this->event_time = & new clsControl(ccsLabel, "event_time", "event_time", ccsDate, array("LongTime"), CCGetRequestParam("event_time", ccsGet, NULL), $this);
        ...
        $this->event_title = & new clsControl(ccsLink, "event_title", "event_title", ccsText, "", CCGetRequestParam("event_title", ccsGet, NULL), $this);
        ...
        $this->events_groups_TotalRecords = & new clsControl(ccsLabel, "events_groups_TotalRecords", "events_groups_TotalRecords", ccsText, "", CCGetRequestParam("events_groups_TotalRecords", ccsGet, NULL), $this);
...
//Show Method @5-B98497D8
    function Show()
    {
        ...
        $this->DataSource->Parameters["urls_category"] = CCGetFromGet("s_category", NULL);
        $this->DataSource->Parameters["seslocale"] = CCGetSession("locale", NULL);
        $this->DataSource->Parameters["urlcategories_langs_category_id"] = CCGetFromGet("categories_langs_category_id", NULL);
        $this->DataSource->Parameters["urls_event_date_to"] = CCGetFromGet("s_event_date_to", NULL);
        $this->DataSource->Parameters["urls_event_date_from"] = CCGetFromGet("s_event_date_from", NULL);
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["event_title"] = $this->event_title->Visible;
...
//Prepare Method @5-DE06D397
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urls_category", ccsInteger, "", "", $this->Parameters["urls_category"], "", false);
        $this->wp->AddParameter("2", "seslocale", ccsText, "", "", $this->Parameters["seslocale"], "", false);
        $this->wp->AddParameter("3", "urlcategories_langs_category_id", ccsInteger, "", "", $this->Parameters["urlcategories_langs_category_id"], "", true);
        $this->wp->AddParameter("4", "urls_event_date_to", ccsDate, $DefaultDateFormat, array("yyyy", "-", "mm", "-", "dd", " ", "HH", ":", "nn", ":", "ss"), $this->Parameters["urls_event_date_to"], "", false);
        $this->wp->AddParameter("5", "urls_event_date_from", ccsDate, $DefaultDateFormat, array("yyyy", "-", "mm", "-", "dd", " ", "HH", ":", "nn", ":", "ss"), $this->Parameters["urls_event_date_from"], "", false);
        ...
        $this->wp->Criterion[3] = $this->wp->Operation(opIsNull, "categories_langs.category_id", $this->wp->GetDBValue("3"), $this->ToSQL($this->wp->GetDBValue("3"), ccsInteger),true);
        $this->wp->Criterion[4] = $this->wp->Operation(opLessThanOrEqual, "events.event_date", $this->wp->GetDBValue("4"), $this->ToSQL($this->wp->GetDBValue("4"), ccsDate),false);
        $this->wp->Criterion[5] = $this->wp->Operation(opGreaterThanOrEqual, "events.event_date", $this->wp->GetDBValue("5"), $this->ToSQL($this->wp->GetDBValue("5"), ccsDate),false);
