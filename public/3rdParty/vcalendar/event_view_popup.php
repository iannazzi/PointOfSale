...
//Class_Initialize Event @5-6500736C
...
//Initialize Objects @1-5272D435
$DBcalendar = new clsDBcalendar();
$MainPage->Connections["calendar"] = & $DBcalendar;

// Controls
$event_name = & new clsControl(ccsLabel, "event_name", "event_name", ccsText, "", CCGetRequestParam("event_name", ccsGet, NULL), $MainPage);
$eventGrid = & new clsGrideventGrid("", $MainPage);
$close_link = & new clsControl(ccsLink, "close_link", "close_link", ccsText, "", CCGetRequestParam("close_link", ccsGet, NULL), $MainPage);
$close_link->Page = "javascript:self.close()";
$print_link = & new clsControl(ccsLink, "print_link", "print_link", ccsText, "", CCGetRequestParam("print_link", ccsGet, NULL), $MainPage);
