...
//Class_Initialize Event @127-6F67AF58
    function clsRecordvertical_menuVerticalMenu($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->RegLink->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
...
//CheckErrors Method @127-592FDCCB
...
//BindEvents Method @1-655645AA
    function BindEvents()
    {
        $this->VerticalMenu->locale->CCSEvents["BeforeShow"] = "vertical_menu_VerticalMenu_locale_BeforeShow";
