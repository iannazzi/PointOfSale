...
//clsSQLParameters Class @0-68DCF6A2
...
//clsSQLParameter Class @0-87BFB354
class clsSQLParameter
{
  var $Errors;
  var $DataType;
  ...
  function SetDBValue($DBValue)
  {
    if (is_array($DBValue)) {
      ...
      $this->DBValue = $DBValue;
      $this->Value = $this->GetParsedValue($this->DBValue, $this->DBFormat, $isDbFormat);
      $this->Text = $this->GetFormattedValue($this->Format);
    }
  }
...
//clsFileUpload Class @0-79E21E53
class clsFileUpload
{
